...
interface NovaDemandaReembolsoSheetProps {
  eventoId?: string;
}
...
export function NovaDemandaReembolsoSheet({ eventoId }: NovaDemandaReembolsoSheetProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await adicionarDemandaReembolso.mutateAsync({
  ...
  return (
    <FormSheet
      ...
      description="Crie uma nova solicitação de reembolso com múltiplos itens"
      onSubmit={handleSubmit}
      onCancel={handleCancel}
      submitText="Criar Solicitação"
      isLoading={adicionarDemandaReembolso.isPending}
      size="xl"
    >
