...
interface ConverterContratoSheetProps {
  contrato: Contrato | null;
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function ConverterContratoSheet({ contrato, open, onOpenChange }: ConverterContratoSheetProps) {
  ...
  return (
    <FormSheet
      ...
      title="Converter Proposta em Contrato"
      onSubmit={handleFormSubmit}
      submitText="Converter e Criar Contrato"
      isLoading={converterPropostaEmContrato.isPending}
      size="lg"
    >
