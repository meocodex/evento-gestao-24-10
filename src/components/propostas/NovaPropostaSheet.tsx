...
interface NovaPropostaSheetProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function NovaPropostaSheet({ open, onOpenChange }: NovaPropostaSheetProps) {
  ...
  return (
    <FormSheet
      ...
      title={`Nova Proposta Comercial - Passo ${step} de 5`}
      onSubmit={handleFormSubmit}
      submitText={step === 5 ? 'Criar Proposta' : 'Próximo'}
      isLoading={criarContrato.isPending}
      size="xl"
    >
      <div className="space-y-6">
        ...
        {/* Navegação customizada para steps */}
        {step < 5 && (
