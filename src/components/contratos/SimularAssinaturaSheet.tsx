...
interface SimularAssinaturaSheetProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  contrato: Contrato | null;
}

export function SimularAssinaturaSheet({ open, onOpenChange, contrato }: SimularAssinaturaSheetProps) {
  ...
  return (
    <DetailsSheet
      ...
      title="Simulação de Assinaturas"
      description="Esta é uma simulação para desenvolvimento. Em produção, as assinaturas serão feitas via ZapSign."
    >
