        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Select {...register('tipo')} onValueChange={(value) => setValue('tipo', value as any)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          {status === 'recebido' && (
            <div>
              ...
              <Select {...register('forma_recebimento')} onValueChange={(value) => setValue('forma_recebimento', value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
