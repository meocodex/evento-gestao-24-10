/**
 * Barrel export para hooks de demandas
 */

export { useDemandasQueries } from '@/contexts/demandas/useDemandasQueries';
export { useDemandasMutations } from '@/contexts/demandas/useDemandasMutations';
